...
echo
echo "请按代理端口实际支持的协议填写："
echo "  混合端口（同时支持 SOCKS5/HTTP）：优先使用 socks5://127.0.0.1:10808"
echo "  仅支持 SOCKS5：                     使用 socks5://127.0.0.1:10808"
echo "  仅支持 HTTP：                       使用 http://127.0.0.1:10808"
echo "  协议前缀必须与端口实际能力一致；混合端口优先 SOCKS5，代理 DNS 兼容性通常更好。"
echo ""
